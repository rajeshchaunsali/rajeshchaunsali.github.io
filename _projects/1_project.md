...
Metamaterials are engineered materials designed to exhibit unconventional properties that do not exist in nature. A key frontier in this field is topological metamaterials, which are structures where energy behaves in robust and unexpected ways. Unlike conventional materials, their unique properties arise from the topology of wave dispersion, enabling precise energy localization and guidance.
...
Can we engineer materials that trap and direct vibrations with precision? If so, we open up new possibilities for energy manipulation, paving the way for smarter materials in several areas, including:

-   Efficient signal processing, by enhancing wave control for improved communication and sensing.
-   Energy harvesting, by capturing and converting mechanical energy more effectively.
-   Unconventional computing, by leveraging wave-based information processing for novel computing architectures.
...
Our research explores whether novel topological phenomena emerge in different types of systems, including:

-   Periodic and quasi-periodic lattices (patterned structures)
-   Disordered systems (investigating how randomness affects wave behavior)
-   Driven and lossy systems (exploring energy input and output dynamics)
-   Nonlinear materials (discovering new physics beyond traditional limits)
